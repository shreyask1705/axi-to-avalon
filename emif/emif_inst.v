	emif u0 (
		...
		.mem_dqs              (_connected_to_mem_dqs_),              //   inout,     width = 2,                   .mem_dqs
		.mem_dqs_n            (_connected_to_mem_dqs_n_),            //   inout,     width = 2,                   .mem_dqs_n
		.mem_dq               (_connected_to_mem_dq_),               //   inout,    width = 16,                   .mem_dq
		.mem_dbi_n            (_connected_to_mem_dbi_n_),            //   inout,     width = 2,                   .mem_dbi_n
		...
		.amm_readdata_0       (_connected_to_amm_readdata_0_),       //  output,   width = 128,                   .readdata
		.amm_writedata_0      (_connected_to_amm_writedata_0_),      //   input,   width = 128,                   .writedata
		.amm_burstcount_0     (_connected_to_amm_burstcount_0_),     //   input,     width = 7,                   .burstcount
		.amm_byteenable_0     (_connected_to_amm_byteenable_0_),     //   input,    width = 16,                   .byteenable
