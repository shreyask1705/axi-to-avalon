...
set ::GLOBAL_emif_altera_emif_arch_fm_191_g54ma2a_corename emif_altera_emif_arch_fm_191_g54ma2a

set var(PROTOCOL)                                                DDR4
set var(NUM_RANKS)                                               1
set var(SLEW_RATE_DRAM)                                          4.0
set var(SLEW_RATE_DRAM_CLOCK)                                    8.0
set var(VIN_Ms)                                                  0.115
set var(VIN_Mh)                                                  0.057
...
set var(UI)                                                      0.833
set var(tCK)                                                     0.682
set var(tDQSQ)                                                   0.047740000000000005
set var(tQH)                                                     0.43
...
set var(PHY_REF_CLK_FREQ_MHZ)                                    300.0
set var(PHY_REF_CLK_JITTER_PS)                                   10.0
set var(PLL_REF_CLK_FREQ_PS_STR)                                 "3336 ps"
