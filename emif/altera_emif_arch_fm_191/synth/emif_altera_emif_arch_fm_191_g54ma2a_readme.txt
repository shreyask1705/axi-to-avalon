...
---------------------------------------------------
   ...
   mem_dqs                        2       bidir       Data strobe
   mem_dqs_n                      2       bidir       Data strobe (negative leg)
   mem_dq                         16      bidir       Read/write data
   mem_dbi_n                      2       bidir       Acts as either the data bus inversion pin, or the data mask pin, depending on configuration. 
...
----------------------------------------------------
   ...
   amm_readdata_0                 128     output      Read data
   amm_writedata_0                128     input       Write data
   amm_burstcount_0               7       input       Number of transfers in each read/write burst
   amm_byteenable_0               16      input       Byte-enable for write data
...
--------------------
   ...
   SYS_INFO_UNIQUE_ID                                : emif_emif_fm_0
   ...
   MEM_TTL_DATA_WIDTH                                : 16
   MEM_TTL_NUM_OF_READ_GROUPS                        : 2
   MEM_TTL_NUM_OF_WRITE_GROUPS                       : 2
   MEM_DDR4_FORMAT_ENUM                              : MEM_FORMAT_DISCRETE
   MEM_DDR4_DQ_WIDTH                                 : 16
   ...
   MEM_DDR4_TTL_DQS_WIDTH                            : 2
   MEM_DDR4_TTL_DQ_WIDTH                             : 16
   ...
   MEM_DDR4_TRFC_NS                                  : 550.0
   MEM_DDR4_TWR_NS                                   : 15.0
   MEM_DDR4_TWTR_L_CYC                               : 11
