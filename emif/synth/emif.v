...
module emif (
	...
	emif_altera_emif_fm_262_6c7fyqi emif_fm_0 (
		...
		.amm_writedata_0      (amm_writedata_0),      //   input,   width = 128,                   .writedata
		.amm_burstcount_0     (amm_burstcount_0),     //   input,     width = 7,                   .burstcount
		.amm_byteenable_0     (amm_byteenable_0),     //   input,    width = 16,                   .byteenable
